...
class CoordinateND {
    ...
    fun averageCoordinate( y: CoordinateND): CoordinateND?{
        when{
            this.direction == Direction.LENGTH && y.direction == Direction.LENGTH -> {
                return CoordinateND((this.seconds+y.seconds)/2, (this.minutes+y.minutes)/2, (this.degrees+y.degrees)/2, Direction.LENGTH)
            }
            this.direction == Direction.WIDTH && y.direction == Direction.WIDTH -> {
                return CoordinateND((this.seconds+y.seconds)/2, (this.minutes+y.minutes)/2, (this.degrees+y.degrees)/2,Direction.WIDTH)
            }
        }
        return null
    }

    fun averageCoordinateTwoParameters(x: CoordinateND, y: CoordinateND): CoordinateND?{
        when{
            x.direction == Direction.LENGTH && y.direction == Direction.LENGTH -> {
                return CoordinateND((x.seconds+y.seconds)/2, (x.minutes+y.minutes)/2, (x.degrees+y.degrees)/2, Direction.LENGTH)
            }
            x.direction == Direction.WIDTH && y.direction == Direction.WIDTH -> {
                return CoordinateND((x.seconds+y.seconds)/2, (x.minutes+y.minutes)/2, (x.degrees+y.degrees)/2, Direction.WIDTH)
            }
        }
        return null
    }
    ...
    override fun toString(): String {
        return "CoordinateND(direction=$direction, minutes=$minutes, seconds=$seconds, degrees=$degrees)"
    }
